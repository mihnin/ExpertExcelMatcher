...
class ExpertMatcher:
    ...
    def create_help_tab(self):
        ...
        help_text_files = """
✅ ОБЩИЕ ТРЕБОВАНИЯ:
   • Формат файлов: .xlsx, .xls или .csv (NEW в v2.1!)
   • Кодировка CSV: автоматическое определение (UTF-8, CP1251, Windows-1251, Latin1)
...
"""
        ...
        section2_5 = tk.LabelFrame(scrollable_frame, text="🧮 Алгоритм автоматического выбора метода (NEW в v2.1)",
                                font=("Arial", 11, "bold"), padx=15, pady=10, bg="white")
